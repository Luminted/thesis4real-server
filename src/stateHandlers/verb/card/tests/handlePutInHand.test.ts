...
import { mockClient1, cardEntityMock1, handCardMock1, mockClient2 } from '../../../../mocks';
...
describe(`Handler for ${ECardVerbTypes.PUT_IN_HAND} verb`, () => {
    ...
    const {clientInfo: {clientId: clientId1}} = mockClient1
    const {clientInfo: {clientId: clientId2}} = mockClient2;
    ...
    beforeEach('Setting up test data...', () => {
        ...
        gameStateStore.changeState(draft => {
            ...
            draft.clients.set(clientId1, {...mockClient1, grabbedEntity: {
                entityId: entityId,
